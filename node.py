...
class node:
	...
	def create_genesis_transaction(self, num_of_nodes):
		...
		init_wallet = {}
		init_wallet[sender] = [{"stake": 0, "usable_amount": amount}]
	...
	def create_transaction(self, sender_public, senderID, receiver_public, receiverID, type_of_transaction,
						   amount, message):
		#TODO: should we give the nonce as a parameter too ?
	...
	def validate_transaction(self, wallets, t):
		...
		try:
			...
			#TODO: check if we need to do sth with the nonce here too
	...
	def validate_chain(self, blocklist):
		...
		tmp_wallets[btstrp_public_k] = [{"stake": 0, "usable_amount": amount}]
